...
import { barChartMockData, TEST_CLASSMATES, testOptionsTeacher, testOptionsVicePrincipal } from '../../mocks/data';
                    ...
                    <ResultsCard
                        ...
                        icon={
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33337 12.6413L10.9361 15L16.3334 10" stroke="#303030" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <ResultsCard
                        ...
                        icon={
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12.6666 8.12109L12.6666 12.1211L15.6666 12.1211" stroke="#060606" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M18.6666 4L20.7317 6.06504" stroke="#060606" stroke-width="2" stroke-linecap="round" />
                                <path d="M6.73169 4L4.66664 6.06504" stroke="#060606" stroke-width="2" stroke-linecap="round" />
                            </svg>
